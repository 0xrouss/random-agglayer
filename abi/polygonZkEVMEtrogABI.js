export const polygonZkEVMEtrogABI = [
    {
        inputs: [
            {
    ...
    { inputs: [], name: "FinalAccInputHashDoesNotMatch", type: "error" },
    ...
    { inputs: [], name: "ForceBatchesDecentralized", type: "error" },
    {
        inputs: [],
    ...
    { inputs: [], name: "HugeTokenMetadataNotSupported", type: "error" },
    { inputs: [], name: "InitNumBatchAboveLastVerifiedBatch", type: "error" },
    { inputs: [], name: "InitNumBatchDoesNotMatchPendingState", type: "error" },
    { inputs: [], name: "InitSequencedBatchDoesNotMatch", type: "error" },
    { inputs: [], name: "InvalidInitializeTransaction", type: "error" },
    ...
    { inputs: [], name: "MaxTimestampSequenceInvalid", type: "error" },
    ...
    { inputs: [], name: "NotEnoughPOLAmount", type: "error" },
